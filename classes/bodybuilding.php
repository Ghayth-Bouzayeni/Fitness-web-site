...
<body>
    ...
    <div class="container"><a href="./chest.php"><div class="PAR"><h1>CHEST</h1></div></a>  
    <a href="./back.php"><div class="PART2"><h1> BACK</h1></div></a>
    <a href="./leg.php"><div class="PART3"><h1> LEGS</h1></div></a> 
    <a href="./arm.php"> <div class="PART4"><h1> ARMS</h1></div></a> </div>
    <footer class="end">
        <div class="endl">
